...
enum StackERROR {
    ...
    NULL_STACK = 1,
    CREATED_STACK = 2,
    STACK_LEFT_CANARY_DAMAGED = 3,
    STACK_RIGHT_CANARY_DAMAGED = 4,
    STACK_LEFT_CANARY_DATA_DAMAGED = 5,
    STACK_RIGHT_CANARY_DATA_DAMAGED = 6,
    STACK_HASH_BASE_DAMAGED = 7,
    STACK_HASH_DATA_DAMAGED = 8,
    STACK_NO_MEMORY = 9,
    EMPTY_STACK = 10,
    STACK_SIZE_MORE_CAPACITY = 11,
    STACK_SIZE_OF_ENUM = 12
};
